...
def write_image(output_path: str, img: np.ndarray, depth: int = 8):
    """
    Write a ndarray <img> into <output_path>, LDR or HDR according to extension specified in <output_path>.
...
def check_light_level(directory, just_face=False, just_light=False, verbose=False):
    """
    ...
    """
    for component, file_name in config.compo_filename.items():
...
if __name__ == '__main__':
    data_dir = r"D:\AlbedoRecon\example\013-20-01"
